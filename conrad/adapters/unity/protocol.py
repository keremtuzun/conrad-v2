...
CONTROL_BODIES: BodyRegistry = {
    ...
    MessageKind.CONFIGURE_SCENE: SceneConfigureRequest,
    MessageKind.SCENE_ACK: SceneAck,
    MessageKind.FRAME_PROBE: FrameProbeRequest,
    MessageKind.FRAME_PROBE_ACK: FrameProbeReply,
